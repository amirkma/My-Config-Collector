# Config Collector (V2Ray / VLESS / VMess / Trojan / SS)

این پروژه به صورت **خودکار** هر ساعت یک بار کانفیگ‌های V2Ray، VLESS، VMess، Trojan و Shadowsocks رو از کانال‌های تلگرام عمومی جمع‌آوری می‌کنه و به صورت subscription آماده می‌کنه.

آپدیت‌ها کاملاً اتوماتیک با GitHub Actions انجام می‌شه.

## لینک‌های Subscription (خام)

این لینک‌ها رو مستقیم توی کلاینتت (مثل v2rayNG، Hiddify، Nekoray، v2rayN و ...) اضافه کن:
